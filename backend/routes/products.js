  ...
  try {
    ...
    const [snapRows] = await pool.query(`
      SELECT
        ...
        ps.unite_special AS snapshot_unite_special,
        ps.nbr_barre AS snapshot_nbr_barre,
        ps.facteur_barre AS snapshot_facteur_barre,
        ps.bon_commande_id,
    ...
    for (const snap of snapRows) {
      ...
      result.push({
        ...
        snapshot_unite_special: Number(snap.snapshot_unite_special || 0),
        snapshot_nbr_barre: snap.snapshot_nbr_barre !== null ? Number(snap.snapshot_nbr_barre) : null,
        snapshot_facteur_barre: snap.snapshot_facteur_barre !== null ? Number(snap.snapshot_facteur_barre) : null,
