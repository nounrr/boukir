...
const bonPagedConfigs = {
  Commande: {
    ...
    selectExtra: `f.nom_complet AS fournisseur_nom, f.societe AS fournisseur_societe, v.nom AS vehicule_nom`,
  ...
  Sortie: {
    ...
    selectExtra: `c.nom_complet AS client_nom, c.societe AS client_societe, f.nom_complet AS fournisseur_nom, f.societe AS fournisseur_societe, v.nom AS vehicule_nom`,
  ...
  Avoir: {
    ...
    selectExtra: `c.nom_complet AS client_nom, c.societe AS client_societe, f.nom_complet AS fournisseur_nom, f.societe AS fournisseur_societe`,
  ...
  AvoirFournisseur: {
    ...
    selectExtra: `f.nom_complet AS fournisseur_nom, f.societe AS fournisseur_societe`,
