        ...
        COALESCE((
          SELECT JSON_ARRAYAGG(
            JSON_OBJECT(
              ...
              'prix_achat', CASE WHEN COALESCE(p.est_service, 0) = 1 THEN 0 ELSE COALESCE(pv.prix_achat, p.prix_achat, 0) END,
              'cout_revient', CASE WHEN COALESCE(p.est_service, 0) = 1 THEN 0 ELSE COALESCE(pv.cout_revient, p.cout_revient, pv.prix_achat, p.prix_achat, 0) END,
