...
// Module "Projets" réservé au PDG. Ces tables sont volontairement isolées :
// aucune écriture sur le stock, la caisse ou les statistiques de l'application.
export const PROJETS_SCHEMA_STATEMENTS = [
