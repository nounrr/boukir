-- Correct client 220 Bons Sortie and Avoirs Client prices using current variant/product cost first.
-- Snapshot cost is only a fallback so old snapshots do not keep old prices.
