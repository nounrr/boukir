...
const productsApi = api.injectEndpoints({
  endpoints: (builder) => ({
    ...
    >({
      query: (body) => ({
        url: '/products/sale-price-corrections',
        method: 'PATCH',
        body,
      }),
      invalidatesTags: ['Product'],
