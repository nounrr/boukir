...
export const api = createApi({
  ...
  tagTypes: ['Employee', 'ClientCollaborationPermissions', 'MaalemReviewPermissions', 'MaalemReview', 'Product', 'Contact', 'ContactGroup', 'ContactComment', 'Dashboard', 'Bon', 'Payment', 'Category', 'MaalemCategory', 'MaalemProfile', 'Service', 'Vehicule', 'Commande', 'Sortie', 'Comptant', 'Charge', 'AvoirCharge', 'ComptantPayment', 'Devis', 'AvoirClient', 'AvoirFournisseur', 'AvoirComptant', 'AvoirEcommerce', 'Ecommerce', 'Remise', 'RemiseItem', 'Talon', 'DocumentType', 'EmployeeDoc', 'OldTalonCaisse', 'FondCaisse', 'FondCaissePermissions', 'StatsDetailsPermissions', 'AccessSchedule', 'UiSettings', 'PricePurchaseSolver', 'DepotStock', 'PhotoShoot', 'ProductNameCorrection', 'SlowMovingStock', 'Absence', 'AbsencePermissions', 'Delivery', 'DeliveryAccess'],
  endpoints: () => ({}),
});
