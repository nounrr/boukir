...
--
-- Table structure for table `talons`
--
...
CREATE TABLE `talons` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_talons_nom` (`nom`),
  KEY `idx_talons_phone` (`phone`)
...
INSERT INTO `talons` VALUES (1,'OUSAMAA','08765RA','2025-08-23 20:14:14','2025-08-23 20:18:36');
