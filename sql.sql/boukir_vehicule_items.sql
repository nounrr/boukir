...
--
-- Table structure for table `vehicule_items`
--

DROP TABLE IF EXISTS `vehicule_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vehicule_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_vi_bv` (`bon_vehicule_id`),
  KEY `fk_vi_product` (`product_id`),
...
--
-- Dumping data for table `vehicule_items`
--

LOCK TABLES `vehicule_items` WRITE;
/*!40000 ALTER TABLE `vehicule_items` DISABLE KEYS */;
INSERT INTO `vehicule_items` VALUES (1,1,10175,1.000,514.69,0.00,0.00,514.69,'2025-08-21 19:54:42',NULL);
/*!40000 ALTER TABLE `vehicule_items` ENABLE KEYS */;
UNLOCK TABLES;
