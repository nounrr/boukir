                        ...
                        >
                          ...
                          {bons.map((bon: Bon) => (
                            <option key={bon.id} value={bon.id}>
                              {bon.numero} - {bon.type} - {bon.montant_total.toFixed(2)} DH
                            </option>
                          ))}
                        </Field>
                      ...
                      <div>
                        <div className="p-4 bg-gray-50 rounded-lg mb-4">
                          ...
                          <div className="text-sm text-gray-600">
                            ...
                            <p><strong>Montant :</strong> {selectedBon.montant_total.toFixed(2)} DH</p>
                                ...
                                <div key={item.product_id} className="flex items-center p-2 hover:bg-gray-50 rounded">
                                  ...
                                  <label htmlFor={`product-${item.product_id}`} className="ml-2 flex-1 cursor-pointer">
                                    ...
                                    <div className="text-sm text-gray-500">
                                      {item.quantite} x {item.prix_unitaire.toFixed(2)} DH = {(item.quantite * item.prix_unitaire).toFixed(2)} DH
                                    </div>
                                  </label>
                                </div>
                              ))}
